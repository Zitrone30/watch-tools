...
public class StreamerMode extends Module {
      ...
      if (MeteorClient.mc != null && MeteorClient.mc.player != null && MeteorClient.mc.getNetworkHandler() != null && isGenerifyNames()) {
         ...
         for (PlayerListEntry player : MeteorClient.mc.getNetworkHandler().getPlayerList()) {
            if (player.getProfile() != null) {
               String fakeName = GenericNamesStuff.genericNames.getName(player.getProfile().getId());
   ...
   public static Optional<String> getPlayerEntityName(PlayerEntity player) {
      return isGenerifyNames() && MeteorClient.mc.getNetworkHandler() != null && !player.getGameProfile().getId().equals(MeteorClient.mc.player.getUuid()) && MeteorClient.mc.getNetworkHandler() != null && isGenerifyNames() ? Optional.of(GenericNamesStuff.genericNames.getName(player.getGameProfile().getId())) : Optional.empty();
   }
}
