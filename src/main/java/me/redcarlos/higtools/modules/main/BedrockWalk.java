...
public class BedrockWalk extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        mc.player.setVelocity(
            velocity.x + normalizedDirection.x * horizontalPullStrength.get(),
            velocity.y + normalizedDirection.y * verticalPullStrength.get(),
            velocity.z + normalizedDirection.z * horizontalPullStrength.get()
        );
